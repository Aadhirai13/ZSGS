...
public class PersonalExpenseView implements PersonalExpenseControllerViewCallBack {
    private Scanner scanner = new Scanner(System.in);
    private PersonalExpenseViewControllerCallBack personalExpenseController;
    private boolean canContinue = true;
    public PersonalExpenseView(){
        personalExpenseController = new PersonalExpenseController(this);
    }

    static public void main(String[] args){
        PersonalExpenseView personalExpenseView = new PersonalExpenseView();
    ...
    private void getInitializeDetails() {
        ...
        personalExpenseController.storeInitialData(name,salary,fixedExpenses,expensePercentage);
        getDailyExpenditure();
    }
                ...
                while(canContinue) {
                    ...
                    switch (choice){
                        case 1:
                        {
                            ...
                            personalExpenseController.storeDailyExpenses(LocalDate.now(), currDayExpense,reason);
                            break;
                        }
                        case 2:
                        {
                            personalExpenseController.getThisMonthExpenditures();
                            break;
                        }
                        case 3:
                        {
    ...
    private void writeInFile() {
        MonthlyExpense expense = personalExpenseController.getExpenses();
