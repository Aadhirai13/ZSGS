package com.zsgs.socialnetworkapplication.welcome;

import com.zsgs.socialnetworkapplication.login.LoginView;
import com.zsgs.socialnetworkapplication.createnewaccount.CreateNewAccountView;

import java.util.Scanner;

public class WelcomeView {
    private Scanner scanner = new Scanner(System.in);
    private CreateNewAccountView createNewAccountView;
