package com.zsgs.mvvm.cricketscoreboardmanagement.repository;

import com.zsgs.mvvm.cricketscoreboardmanagement.dto.Batting;
import com.zsgs.mvvm.cricketscoreboardmanagement.dto.Fieldin;
...
public class ScoreBoardRepository {
    ...
    private static ScoreBoardDetail liveMatchDetails = new ScoreBoardDetail();
    private static ArrayList<Batting> battingDetails = new ArrayList<>();
    private static ArrayList<Fieldin> fieldingDetails = new ArrayList<>();
    ...
    private static void setTeamNames() {
        ...
        teams.add(new Team("CSK", team1Players, 0, individualScores, ballsBowled));
        ArrayList<String> team2Players = new ArrayList<>(setTeamPlayers(2));
        teams.add(new Team("RCB", team2Players, 0, individualScores, ballsBowled));
    }
    ...
    public ScoreBoardDetail getScoreBoard() {
        ScoreBoardDetail scoreBoardDetails = liveMatchDetails;
    ...
    public void setBatFieldTeam(boolean isBatting) {
        ...
        if (isBatting) {
            ...
            fieldingDetails.add(new Fieldin());
    ...
    private void changeBowler() {
        for(Fieldin fielding : fieldingDetails){
    ...
    public ArrayList<Team> getOverallScoreBoard() {
        return teams;
    }
