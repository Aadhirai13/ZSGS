package com.zsgs.mvvm.personalexpensemanagement.dto;
...
public class MonthlyExpenses {
    ...
    public MonthlyExpenses(String name, int salary, int fixedExpense, float expensePercentage, ArrayList<Float> dailyExpenditures, ArrayList<String> reasons, float totalDailyExpenditures) {
        setName(name);
        setSalary(salary);
